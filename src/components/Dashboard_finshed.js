...
const Dashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState("settings"); // Active tab for workspace settings
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              defaultValue={user?.name || "Workspace"}
            />
          </div>
          <div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">{user?.subscription || "Free Plan"}</p>
              </div>
            </div>
            {/* Dropdown Toggle */}
            <button
